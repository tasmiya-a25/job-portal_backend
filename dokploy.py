...
API_URL = "http://13.200.17.101:3000/api/project.all"
api_key = "GsqhxXvVeCByCvaYZsGaiELMukmFvuYKJPfKpBcRwzxnRPWdLqrqSmUDcfgdjfLf"
app_name = "job-portal-backend-godpwh"
